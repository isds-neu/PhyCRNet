...
def postProcess(output, xmin, xmax, ymin, ymax, num, fig_save_dir):
    ...
    cf = ax[0].scatter(x_star, y_star, c=u, alpha=0.95, edgecolors='none', cmap='RdYlBu', 
           marker='s', s=3)
    ax[0].axis('square')
...
if __name__ == '__main__':
    ...
    for step in range(N_simulation_steps):
        ...
        # RK4
        A, B = update_rk4(A, B, DU=1.0, DV=100.0, alpha=0.01, beta=0.25, dt=delta_t, dx=1.0)
